...
public class Lab_9 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("\t5.Modificar el archivo creado");
        System.out.println("\t6.Eliminar el archivo");
        ...
        switch (option){
            ...
            case 4:
                ...
                break;
            case 5:
                FileMethod methodUpdate = new FileMethod();
                Scanner readText = new Scanner(System.in);
                System.out.print("\n\tIngrese el texto a cambiar: ");
                compareText = readText.next();
                System.out.print("\tIngrese el nuevo texto: ");
                newText = readText.next();
                methodUpdate.updateFile("RegistroEdadUsers.csv", compareText, newText);
                System.in.read();
                break;
            case 6:
                FileMethod methodDelete = new FileMethod();
                methodDelete.deleteFile("RegistroEdadUsers.csv");
                System.in.read();
                break;
            case 0:
                System.exit(0);
